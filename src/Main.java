...
class Main {
    //data buku
    public static String[] idBuku = new String[] {"18", "12", "04"};
    public static String[] namaBuku = new String[] {"aku", "kamu", "malang"};
    public static String[] author = new String[] {"dyta", "dyta", "dyta"};
    public static String[] category = new String[] {"romantis", "romantis", "Sejarah"};
